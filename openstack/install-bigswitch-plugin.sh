#!/usr/bin/env bash
#
# This script patches the OpenStack Quantum Folsom Ubuntu installation
...
TEMP_DIR='/tmp/bsn'
Q_DB_NAME='quantum'
PLUGIN_URL='https://github.com/bigswitch/quantum/archive/folsom/master.tar.gz'
PLUGIN_TAR='bsn.tar.gz'
TEMP_PLUGIN_PATH='/quantum-folsom-master/quantum/plugins/bigswitch'
TEMP_PLUGIN_CONF_PATH='/quantum-folsom-master/etc/quantum/plugins/bigswitch'
