...
NOVA_BRANCH=kbenton/ivssupport_grizzly
NOVA_REPO='https://github.com/bigswitch/nova.git'
QUANTUM_BRANCH=kbenton/ivssupport
QUANTUM_REPO='https://github.com/bigswitch/quantum.git'
...
echo "   ./install-ivs-node.sh  <comma-separated-list-of-controllers>"
